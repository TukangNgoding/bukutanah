...
<div class="form-group">
	...
	<div class="col-md-8">
	<select id="pencipta" name="noarsip" class="form-control input-md chosen" required>
...
<div class="form-group">
	...
	<div class="col-md-8">
	<select id="pencipta" name="username_peminjam" class="form-control input-md chosen" required>
	<option value="">Silahkan PIlih</option>
	<?php
